...
var symbolCross = '<i class="fa fa-close"></i>'
var symbolCircle = '<i class="fa fa-circle-o"></i>'

$(document).ready(function() {
    // Intro screen buttons
    $("#choose-x").on("click", function() {
        playerSymbol = symbolCross;
        enemySymbol = symbolCircle;
        $("#intro-screen").fadeOut(300, showEnemyScreen);
    });
    $("#choose-o").on("click", function() {
        playerSymbol = symbolCircle;
        enemySymbol = symbolCross;
        $("#intro-screen").fadeOut(300, showEnemyScreen);
    });
